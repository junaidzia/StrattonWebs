        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col mb-2">
                    ...
                    <input class="form-control" type="text" name="blog_title" placeholder="Enter Title" required>
                </div>
                <div class="col mb-2">
                    <label class="form-label">Title Support <span class="text-danger">*</span></label>
                    <input class="form-control" type="text" name="blog_title_support" placeholder="Enter Title Support" required>
                </div>
            </div>
            <div class="row">
                <div class="col mb-2">
                    <label class="form-label">Author <span class="text-danger"> *</span></label>
                    <input class="form-control" type="text" name="blog_user" placeholder="Enter Author" required>
                </div>
                <div class="col mb-2">
                    <label class="form-label">Image<span class="text-danger"> ( 355 by 236 ) px</span></label>
                    <input class="form-control" type="file" name="blog_img" accept=".jpg,.jpeg,.png" required>
                </div>
                <div class="col mb-2">
                    <label class="form-label">Banner<span class="text-danger"> ( 1600 by 833 ) px</span></label>
                    <input class="form-control" type="file" name="blog_banner" accept=".jpg,.jpeg,.png" required>
                </div>
            </div>
            <div class="row">
                <div class="col mb-2">
                    <label class="form-label">Date <span class="text-danger"> *</span></label>
                    <input class="form-control" type="text" name="blog_date" data-provider="flatpickr" placeholder="Enter Date" required>
                </div>
                <div class="col mb-2">
                    <label class="form-label">Tags <span class="text-danger"> *</span></label>
                    <input class="form-control" type="text" name="blog_tags" data-choices data-choices-removeItem placeholder="Enter Tags" required>
                </div>
            </div>
            <div class="row">
                <div class="col mb-2">
                    <label class="form-label mb-0">Detail</label>
                    <textarea name="blog_des" id="ckeditor" class="form-control"></textarea>
                </div>
            </div>
        </div>
