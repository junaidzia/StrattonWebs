        ...
        <div class="card-body">
            <div class="row">
                <div class="col mb-2">
                    ...
                    <select class="form-control" data-choices name="pp_status" required>
                ...
                <div class="col mb-2">
                    ...
                    <input class="form-control" type="text" name="pp_title" placeholder="Enter Title" required>
                </div>
            </div>
            <div class="row">
                <div class="col mb-2">
                    <label class="form-label mb-0">Detail</label>
                    <textarea name="pp_des" id="ckeditor" class="form-control"></textarea>
                </div>
            </div>
        </div>
