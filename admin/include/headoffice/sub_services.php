...
<script>
function add_subservices_detail(){
    $.ajax({
        url : "include/ajax/add_subservices_detail.php",
        type : "POST",
        success : function(response){
            $("#subservices_detail").append(response);
        }
    })
}
function add_subservices_content(){
    $.ajax({
        url : "include/ajax/add_subservices_content.php",
        type : "POST",
        success : function(response){
            $("#subservices_content").append(response);
        }
    })
}
