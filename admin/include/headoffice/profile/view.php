...
echo '
    <div class="position-relative mx-n4 mt-n4">
        <div class="profile-wid-bg profile-setting-img">
            <img src="'.SITE_URL.'/images/profile-bg.jpg" class="profile-wid-img" alt="">
        </div>
    </div>
    <div class="row">
                ...
                <div class="card-body p-4">
                    <div class="text-center">
                        <div class="profile-user position-relative d-inline-block mx-auto  mb-4">
                            <img src="'.SITE_URL.'/images/admin/'.$row['adm_photo'].'" class="rounded-circle avatar-xl img-thumbnail user-profile-image" alt="user-profile-image">
                        </div>
