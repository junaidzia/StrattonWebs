    ...
    (INSPIRO.elements = {
      functions: function () {
        INSPIRO.elements.shapeDivider(),
          ...
          INSPIRO.elements.formAjaxProcessing1(),
      ...
      formAjaxProcessing1: function () {
        var i = t(
          ".widget-contact-form1:not(.custom-js), .ajax-form:not(.custom-js)"
        );
        i.length > 0 &&
          i.each(function () {
            var i = t(this),
